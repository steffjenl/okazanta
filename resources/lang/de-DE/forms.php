...
return [
    ...
    'settings' => [
        ...
        'security' => [
            ...
            'always-authenticate-help'  => 'Anmeldung für alle Okazanta Seiten erzwingen',
        ],
        'stylesheet' => [
    ...
    'user' => [
        ...
        'password'       => 'Passwort',
        'api-token'      => 'API Token',
        'api-token-help' => 'Wenn sie ihren API-Token neu generieren, können bestehende Anwendungen nicht mehr auf Okazanta zugreifen.',
